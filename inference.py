...
def process(
    ...
    # p_p = 'clear, clean, realistic detail, high contrast, ultra HD, hyper sharpness, high-resolution, 8k'
    # n_p = 'blurring, dirty, messy, low quality, jpeg artifacts, lowres, over-smooth, dotted, noise'
    p_p = 'clean, high-resolution, 8k'
    n_p = 'dotted, noise, blur, lowres, smooth'
    # p_p = 'clean, extremely detailed, best quality, sharp, high-resolution, 8k'
    # n_p = 'dotted, low quality, blurry, low-resolution, noisy, unsharp, weird textures, smooth'
