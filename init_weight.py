...
parser.add_argument("--cldm_config", default='configs/model/clip_distill.yaml', type=str)
parser.add_argument("--sd_weight", default='weights/stable_diffusion_2_1_base/v2-1_512-ema-pruned.ckpt', type=str)
parser.add_argument("--output", default='weights/ori.ckpt', type=str)
