...
from ldm.models.diffusion.ddpm_clip import LatentDiffusion
...
class ControlLDM(LatentDiffusion):
    ...
    def get_learned_conditioning(self, c, need_hq=False):
        dropout_rate = 0.5
    ...
    def get_input(self, batch, k, bs=None, *args, **kwargs):
        ...
        return x, dict(c_crossattn=[], c_latent=[], lq=[lq], c_concat=[control], hq = [hq])
